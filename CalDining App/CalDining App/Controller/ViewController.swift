...
//        nextButton.layer.cornerRadius = 4
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell?.detailTextLabel?.text = "\(menuWeights[indexPath.row])"
//        if dataModel[indexPathSelect.row].isSelected {
...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectedCell.append(menuList[indexPath.row])
        print(selectedCell)
    ...
    func tableView(_ tableView: UITableView, didDeselectRowAt indexPath: IndexPath) {
        //print("This cell from the chat list was deselected: \(indexPath.row)")
        selectedCell.remove(at: selectedCell.index(of: menuList[indexPath.row])!)
        print(selectedCell)
        if let cell = tableView.cellForRow(at: indexPath) {
